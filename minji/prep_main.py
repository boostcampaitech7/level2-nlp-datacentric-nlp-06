...
def main():
    ...
    # 모델 학습 (v0.0.3 데이터 기반)
    logging.info("Training the model with v0.0.3 data...")
    ...
    # 모델 학습 (v0.0.4 데이터 기반)
    logging.info("Training the model with v0.0.4 data...")
    ...
    # 모델 학습 (v1.0.2 데이터 기반)
    logging.info("Training the model with v1.0.2 data...")
    ...
    # v1.2.1 - 최종 데이터 병합
    if not os.path.exists("../../datasets/v1.2.1/"):
        os.makedirs("../../datasets/v1.2.1/")
